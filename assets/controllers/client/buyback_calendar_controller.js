...
export default class extends Controller {
    ...
    connect() {
        console.log('Buyback calendar controller connected');
    ...
    renderCalendar() {
        ...
        const isPreviousDisabled = year === todayYear && month === todayMonth;
    ...
    async confirmAppointment() {
        ...
        try {
            const response = await fetch(`/rachat/rdv/${this.tokenValue}/confirm`, {
                method: 'POST',
                headers: {
            ...
            <div style="text-align: center; padding: 60px 40px;">
                ...
                <div style="background: linear-gradient(135deg, rgba(22, 198, 105, 0.08) 0%, rgba(22, 198, 105, 0.02) 100%); border: 2px solid rgba(22, 198, 105, 0.3); border-radius: 12px; padding: 30px; margin-bottom: 30px; text-align: left;">
                    ...
                    <div style="display: flex; align-items: center; gap: 12px; font-size: 1rem;">
                        <i class="fa fa-truck" style="color: #16C669; width: 24px;"></i>
                        <span><strong>Type :</strong> Enlèvement à domicile</span>
                    </div>
                </div>
                ...
                <p style="color: #6c7783; font-size: 0.95rem; line-height: 1.6;">
                    Notre équipe vous contactera la veille pour confirmer.<br>
                    À très bientôt ! 🚚
                </p>
            </div>
        `;
