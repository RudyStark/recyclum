 ...
 */
final class Version20251104120213 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product ALTER energy_label TYPE VARCHAR(255)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product ALTER energy_label TYPE VARCHAR(5)');
    }
}
